export default {
  ...
  recentColorTip: 'Set a specific color to use by clicking More below. Recent 8 customized colors will bed saved. Also, custom colors won’t change if you alter theme.',
  select: 'Select',
  ...
  openingGuideStep4Content: 'Click on the Map widget and drag it to the canvas.',
  ...
  whatsNewStep2Title: 'New: Language support ',
  whatsNewStep2Content: 'Adds Slovak for use as a primary language.',
  whatsNewStep3Title: 'Survey widget',
  whatsNewStep3Content: 'Adds support for previewing a survey before publishing.',
  whatsNewStep4Title: 'Subscriber content',
  whatsNewStep4Content: 'Adds authorizing subscriber content when publishing a template.',
  whatsNewStep13Title: 'See all the new features',
  whatsNewStep13Content: 'Learn more',
  ...
  insertWidgetStep1Content: 'Click on the widget and drag it to the canvas.',
