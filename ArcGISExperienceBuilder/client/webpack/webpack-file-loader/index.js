...
function loader(content) {
  ...
  var context = options.context || this.rootContext || this.options.context;
  ...
  if (options.outputPath) {
    ...
    outputPath = typeof options.outputPath === 'function' ? options.outputPath(url, filePath) : options.outputPath;
  }
