/** @jsx jsx */
import { React, jsx, css, ImmutableArray, UseDataSource } from 'jimu-core';
...
export const usePlugin = (widgetId: string, useDataSources: ImmutableArray<UseDataSource>): RenderPlugin => {
  return React.useMemo(() => {
    return ({ editor, selection, formats }) => {
      return <TextPlugins editor={editor} selection={selection} formats={formats} widgetId={widgetId} useDataSources={useDataSources}></TextPlugins>
    }
