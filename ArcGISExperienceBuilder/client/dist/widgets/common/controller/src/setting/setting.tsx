...
const Setting = (props: ControllerSettingProps) => {
  ...
  return <div className="widget-setting-controller jimu-widget-setting" css={style}>
    ...
    <SettingSection title={translateLocal('appearance', true)}>
      ...
      <SettingRow flow="no-wrap" label={translateLocal('iconSizeOverride')}>
    ...
    <SettingSection>
      ...
      </SettingRow>
      {
        advanced &&
        <SettingAdvanced
          themeBoxDataItems={getThemeBoxDataItems({ getI18nMessage: translateLocal })}
          variant={variant}
          appTheme={appTheme}
          onSettingConfigChange={onSettingConfigChange}
          getI18nMessage={translateLocal}
        />
      }
    </SettingSection>
  </div>
