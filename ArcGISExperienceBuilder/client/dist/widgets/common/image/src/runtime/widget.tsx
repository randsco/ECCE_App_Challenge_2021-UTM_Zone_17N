/** @jsx jsx */
import { React, Immutable, LinkType, RepeatedDataSource, ExpressionResolverComponent, ExpressionResolverErrorCode, Size, lodash, getAppStore,
  css, jsx, AllWidgetProps, DataRecord, ReactResizeDetector, IMExpression, ExpressionPartType, LinkTo, LinkResult, AttachmentInfo, polished, IMUrlParameters, IMState } from 'jimu-core';
...
export default class Widget extends React.PureComponent<AllWidgetProps<IMConfig> & ExtraProps, State>{
  ...
  render() {
    ...
    if (this.props.config.functionConfig.imageFillMode !== ImageFillMode.Fit && this.props.isInlineEditing && this.state.src
      ...
      renderResult = <div className="jimu-widget">
        <ReactResizeDetector handleWidth handleHeight onResize={this.onCropWidgetResize}></ReactResizeDetector>
        {renderResult}
      ...
      renderResult = <div className="jimu-widget" css={this.getStyle()}
        ...
        { <div style={{ display: 'none' }}>
          ...
          }
          {
            ...
            <div>
              <AttachmentComponent record={this.state.record} unmountAttachmentInfosChange={this.unmountAttachmentInfosChange}
          ...
          }
          {
            ...
            <div>
              <SymbolComponent record={this.state.record} unmountSymbolElementChange={this.unmountSymbolElementChange}
