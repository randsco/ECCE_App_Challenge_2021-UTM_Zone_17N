...
declare class _FilterDataRecordActionSetting extends React.PureComponent<ActionSettingProps<IMConfig> & ExtraProps & StateExtraProps, States> {
    ...
    swicthEnabledQueryWithCurrentExtent: (checked: any) => void;
